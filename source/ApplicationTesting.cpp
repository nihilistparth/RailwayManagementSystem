...
void ApplicationTest() {
    ...
    Passenger p1 = Passenger::createPassenger("Prashant", "", "pawar", "842233101212", "04/04/2002", Gender::Male::Type(), "8447763108", 1, 0, "") ;
    Passenger p2 = Passenger::createPassenger("narendra", "", "modi", "842233104545", "29/03/1975", Gender::Female::Type(), "6261171656", 1, 0, "") ;
    Passenger p3 = Passenger::createPassenger("ram", "Chandra", "Shukla", "747933101212", "15/05/1935", Gender::Male::Type(), "84477763108", 3, 0, "") ;
    Passenger p4 = Passenger::createPassenger("Tony", "", "", "842233101212", "04/05/1999", Gender::Male::Type(), "8447763108", 4, 0, "Blind") ;
    Passenger p5 = Passenger::createPassenger("Steve", "", "Rogers", "842233101212", "04/05/1945", Gender::Male::Type(), "8447763108", 4, 0, "Cancer") ;
    ...
    // Booking b6 = Booking::DoBooking(Station("Kolkata"), Station("Bangalore"), "25/06/2020", "25/07/2020", BookingClasses::FirstClass::Type(), BookingCategories::SeniorCitizen::Type(), p3) ;
